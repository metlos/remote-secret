...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TargetSecretStatus) DeepCopyInto(out *TargetSecretStatus) {
	*out = *in
	if in.Labels != nil {
		in, out := &in.Labels, &out.Labels
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TargetSecretStatus.
func (in *TargetSecretStatus) DeepCopy() *TargetSecretStatus {
	if in == nil {
		return nil
	}
	out := new(TargetSecretStatus)
	in.DeepCopyInto(out)
	return out
}
